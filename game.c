...
//vai dizer onde as caixas vao aparece
...
//inicia a visao da "camera" e etc e coloca as caixa
void InitGame() {
...
void UpdateGame(float dt) {
    ...
    switch (state) {
        ...
        //jogador pode colocar a resposta
        case WAIT_INPUT:
        ...
        case SHOW_RESULT:
            if (timer >= 2.0f) {
                ...
                if (lives <= 0) {
                    // reinicia o jogo se acaba as vidas
                    roundNum = 1;
                    lives = 5;
                    score = 0;
                    showTime = 2.0f;
